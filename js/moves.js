...
(function (root) {
  ...
  const TABLE = {
    ...
    'kate.super': { key:'kate.super', startup:6, active:24, recovery:30, damage:42, hitstun:24, blockstun:18, hitKB:8, blockPush:5, height:'mid', knockdown:true, meterGain:0, chip:5, cancelable:false, box:{x:40,y:50,w:64,h:80}, hits:8 },
    // --- Bungus specials ---
